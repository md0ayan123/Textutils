...
<button disabled={text.length==0}className="btn btn-primary mx-2 my-2"style={{border:'2px solid black'}} onClick={handleLoClick}>convert to LowerCase</button>
<button disabled={text.length==0}className="btn btn-primary mx-2 my-2"style={{border:'2px solid black'}} onClick={handleClearText}>Clear  Text</button>
    </div>
